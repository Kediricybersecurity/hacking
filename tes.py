...
def restart_program():
        ...
        curdir = os.getcwd()
os.system("clear")
os.system("figlet XhntrvCsx")
print "Create By : XhntrvCsx"
print "github    : https://github.com/kedirisecurityteam"
print "Facebook  : https://www.facebook.com/anggararaditya"
print
print "           [1]> Brute Force              "
print "           [2]> DDos Attack              "
